...
bool rm_referee_ros2__msg__game_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_referee_ros2.msg._game_status.GameStatus", full_classname_dest, 43) == 0);
  }
  rm_referee_ros2__msg__GameStatus * ros_message = _ros_message;
  {  // game_type
...
PyObject * rm_referee_ros2__msg__game_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_referee_ros2.msg._game_status");
