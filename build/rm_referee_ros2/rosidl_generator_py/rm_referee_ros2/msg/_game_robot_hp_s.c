...
bool rm_referee_ros2__msg__game_robot_hp__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_referee_ros2.msg._game_robot_hp.GameRobotHp", full_classname_dest, 46) == 0);
  }
  rm_referee_ros2__msg__GameRobotHp * ros_message = _ros_message;
  {  // red_1_robot_hp
...
PyObject * rm_referee_ros2__msg__game_robot_hp__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_referee_ros2.msg._game_robot_hp");
