...
bool rm_referee_ros2__msg__shoot_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_referee_ros2.msg._shoot_data.ShootData", full_classname_dest, 41) == 0);
  }
  rm_referee_ros2__msg__ShootData * ros_message = _ros_message;
  {  // bullet_type
...
PyObject * rm_referee_ros2__msg__shoot_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_referee_ros2.msg._shoot_data");
