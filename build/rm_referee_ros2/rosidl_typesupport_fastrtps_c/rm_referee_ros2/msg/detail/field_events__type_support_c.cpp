...
#include "rm_referee_ros2/msg/detail/field_events__rosidl_typesupport_fastrtps_c.h"
...
using _FieldEvents__ros_msg_type = rm_referee_ros2__msg__FieldEvents;
...
static uint32_t _FieldEvents__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rm_referee_ros2__msg__FieldEvents(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_referee_ros2__msg__FieldEvents;
    is_plain =
      (
...
static size_t _FieldEvents__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rm_referee_ros2__msg__FieldEvents(
