...
static const _RobotPos_type_support_symbol_names_t _RobotPos_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_referee_ros2, msg, RobotPos)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rm_referee_ros2, msg, RobotPos)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rm_referee_ros2, msg, RobotPos)() {
  return &::rm_referee_ros2::msg::rosidl_typesupport_c::RobotPos_message_type_support_handle;
}
