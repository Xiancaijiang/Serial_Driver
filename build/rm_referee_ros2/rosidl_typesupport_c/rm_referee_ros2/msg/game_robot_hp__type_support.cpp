...
static const _GameRobotHp_type_support_symbol_names_t _GameRobotHp_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_referee_ros2, msg, GameRobotHp)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rm_referee_ros2, msg, GameRobotHp)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rm_referee_ros2, msg, GameRobotHp)() {
  return &::rm_referee_ros2::msg::rosidl_typesupport_c::GameRobotHp_message_type_support_handle;
}
