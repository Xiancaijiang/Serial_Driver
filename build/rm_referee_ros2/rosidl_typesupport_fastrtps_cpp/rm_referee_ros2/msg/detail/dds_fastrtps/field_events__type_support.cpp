...
#include "rm_referee_ros2/msg/detail/field_events__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rm_referee_ros2::msg::FieldEvents & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rm_referee_ros2::msg::FieldEvents & ros_message)
{
  // Member: event_type
  cdr >> ros_message.event_type;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_referee_ros2::msg::FieldEvents;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rm_referee_ros2::msg::FieldEvents *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_referee_ros2::msg::FieldEvents *>(
    untyped_ros_message);
...
{
  return &rm_referee_ros2::msg::typesupport_fastrtps_cpp::_FieldEvents__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_referee_ros2, msg, FieldEvents)() {
  return &rm_referee_ros2::msg::typesupport_fastrtps_cpp::_FieldEvents__handle;
}
