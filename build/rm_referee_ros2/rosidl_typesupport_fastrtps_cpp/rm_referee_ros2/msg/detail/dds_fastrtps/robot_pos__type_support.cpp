...
#include "rm_referee_ros2/msg/detail/robot_pos__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rm_referee_ros2::msg::RobotPos & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rm_referee_ros2::msg::RobotPos & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_referee_ros2::msg::RobotPos;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rm_referee_ros2::msg::RobotPos *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_referee_ros2::msg::RobotPos *>(
    untyped_ros_message);
...
{
  return &rm_referee_ros2::msg::typesupport_fastrtps_cpp::_RobotPos__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_referee_ros2, msg, RobotPos)() {
  return &rm_referee_ros2::msg::typesupport_fastrtps_cpp::_RobotPos__handle;
}
