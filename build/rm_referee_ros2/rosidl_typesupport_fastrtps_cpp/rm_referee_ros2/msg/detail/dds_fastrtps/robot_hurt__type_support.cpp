...
#include "rm_referee_ros2/msg/detail/robot_hurt__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_referee_ros2::msg::RobotHurt;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rm_referee_ros2::msg::RobotHurt *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_referee_ros2::msg::RobotHurt *>(
    untyped_ros_message);
...
{
  return &rm_referee_ros2::msg::typesupport_fastrtps_cpp::_RobotHurt__handle;
}
