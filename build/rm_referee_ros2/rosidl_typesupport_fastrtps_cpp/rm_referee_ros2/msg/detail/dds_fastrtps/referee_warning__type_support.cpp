...
#include "rm_referee_ros2/msg/detail/referee_warning__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rm_referee_ros2::msg::RefereeWarning & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rm_referee_ros2::msg::RefereeWarning & ros_message)
{
  // Member: level
  cdr >> ros_message.level;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_referee_ros2::msg::RefereeWarning;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rm_referee_ros2::msg::RefereeWarning *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_referee_ros2::msg::RefereeWarning *>(
    untyped_ros_message);
...
{
  return &rm_referee_ros2::msg::typesupport_fastrtps_cpp::_RefereeWarning__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_referee_ros2, msg, RefereeWarning)() {
  return &rm_referee_ros2::msg::typesupport_fastrtps_cpp::_RefereeWarning__handle;
}
