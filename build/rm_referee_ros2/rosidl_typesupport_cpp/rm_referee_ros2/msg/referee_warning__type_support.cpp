...
static const _RefereeWarning_type_support_symbol_names_t _RefereeWarning_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_referee_ros2, msg, RefereeWarning)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_referee_ros2, msg, RefereeWarning)),
  }
};
...
{
  return &::rm_referee_ros2::msg::rosidl_typesupport_cpp::RefereeWarning_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rm_referee_ros2, msg, RefereeWarning)() {
  return get_message_type_support_handle<rm_referee_ros2::msg::RefereeWarning>();
}
