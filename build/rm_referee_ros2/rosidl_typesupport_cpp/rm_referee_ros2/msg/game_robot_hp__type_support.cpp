...
static const _GameRobotHp_type_support_symbol_names_t _GameRobotHp_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_referee_ros2, msg, GameRobotHp)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_referee_ros2, msg, GameRobotHp)),
  }
};
...
{
  return &::rm_referee_ros2::msg::rosidl_typesupport_cpp::GameRobotHp_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rm_referee_ros2, msg, GameRobotHp)() {
  return get_message_type_support_handle<rm_referee_ros2::msg::GameRobotHp>();
}
