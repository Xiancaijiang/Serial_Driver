...
static const _RobotPos_type_support_symbol_names_t _RobotPos_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_referee_ros2, msg, RobotPos)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_referee_ros2, msg, RobotPos)),
  }
};
...
{
  return &::rm_referee_ros2::msg::rosidl_typesupport_cpp::RobotPos_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rm_referee_ros2, msg, RobotPos)() {
  return get_message_type_support_handle<rm_referee_ros2::msg::RobotPos>();
}
