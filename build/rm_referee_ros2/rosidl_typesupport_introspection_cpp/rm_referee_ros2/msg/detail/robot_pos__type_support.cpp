...
{
  new (message_memory) rm_referee_ros2::msg::RobotPos(_init);
}

void RobotPos_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rm_referee_ros2::msg::RobotPos *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotPos_message_member_array[4] = {
  {
    ...
    offsetof(rm_referee_ros2::msg::RobotPos, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_referee_ros2::msg::RobotPos, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_referee_ros2::msg::RobotPos, angle),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_referee_ros2::msg::RobotPos, stamp),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RobotPos_message_members = {
  ...
  4,  // number of fields
  sizeof(rm_referee_ros2::msg::RobotPos),
...
get_message_type_support_handle<rm_referee_ros2::msg::RobotPos>()
{
  return &::rm_referee_ros2::msg::rosidl_typesupport_introspection_cpp::RobotPos_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_referee_ros2, msg, RobotPos)() {
  return &::rm_referee_ros2::msg::rosidl_typesupport_introspection_cpp::RobotPos_message_type_support_handle;
}
